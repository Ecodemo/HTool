package com.smile.qrcode.android;
...
import com.smile.qrcode.bean.ZxingConfig;
import com.smile.qrcode.camera.CameraManager;
import com.smile.qrcode.common.Constant;
import com.smile.qrcode.decode.DecodeImgCallback;
import com.smile.qrcode.decode.DecodeImgThread;
import com.smile.qrcode.decode.ImageUtil;
import com.smile.qrcode.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener
{
    ...
    public void handleDecode(Result rawResult)
	{
		...
		if (content.startsWith("http://") || content.startsWith("https://")){
			...
			intent.putExtra("mUrl", content);
			startActivity(intent);
		}else if (matcher.matches() && content.length() == 13){
			Intent intent= new Intent(this, BrowserActivity.class);
			intent.putExtra("mUrl", "https://www.baidu.com/s?wd="+content);
			startActivity(intent);
		}else if (Pattern.compile(".*://.*").matcher(content).matches()){
			try{
