...
public final class ViewfinderView extends View {
    ...
    public void setZxingConfig(ZxingConfig config) {
        ...
        if (config.getFrameLineColor() != -1) {
            frameLineColor = getContext().getResources().getColor(config.getFrameLineColor());
        }

        scanLineColor = getContext().getResources().getColor(config.getScanLineColor());
        initPaint();
    ...
    private void initPaint() {
        ...
        if (frameLineColor != -1) {
            ...
            frameLinePaint.setColor(getContext().getColor(config.getFrameLineColor()));
