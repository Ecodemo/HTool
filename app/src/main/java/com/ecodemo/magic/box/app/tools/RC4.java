...
public class RC4 extends MxActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		encode.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View view) {
					tow_editor.setText(new RC4().encry_RC4_string(one_editor.getText().toString(),key.getText().toString()));
				}
			});
		decode.setOnClickListener(new OnClickListener(){
				@Override
				public void onClick(View view) {
					tow_editor.setText(new RC4().decry_RC4(one_editor.getText().toString(),key.getText().toString()));
				}
			});
	}
	...
	class RC4 {
		...
		public byte[] encry_RC4_byte(String data, String key) {
			if (data == null || key == null) {
				return null;
			}
