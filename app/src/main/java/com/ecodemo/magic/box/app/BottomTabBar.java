...
import com.ecodemo.magic.box.app.custom.CustomFragmentTabHost;
import java.lang.reflect.Method;
import java.util.ArrayList;
import java.util.List;

import static android.widget.RelativeLayout.CENTER_HORIZONTAL;
import com.ecodemo.magic.box.app.utils.TintUtil;
...
//        fontImgPadding = px2designHeightPx(fontImgPadding);
     ...
     * @return
     */
    public BottomTabBar setChangeColor(int selectColor, int unSelectColor) {
     ...
     * @return
     */
    public BottomTabBar setDividerColor(int color) {
     ...
     * @return
     */
    public BottomTabBar setTabBarBackgroundColor(int color) {
     ...
     * @return
     */
    public BottomTabBar setTabBarBackgroundResource(int resid) {
    ...
    public BottomTabBar addTabItem(String name, int imgId, Class fragmentClass) {
        return addTabItem(name, context.getResources().getDrawable(imgId), fragmentClass);
    }

    public BottomTabBar addTabItem(String name, int imgIdSelect, int imgIdUnSelect, Class fragmentClass) {
        return addTabItem(name, context.getResources().getDrawable(imgIdSelect), context.getResources().getDrawable(imgIdUnSelect), fragmentClass);
    }
