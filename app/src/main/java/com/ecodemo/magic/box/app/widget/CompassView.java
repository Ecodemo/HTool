...
public class CompassView extends View {
    ...
    public CompassView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		typedarray = context.getTheme().obtainStyledAttributes(new int[] {  
																 R.attr.TextColor
															 }); 
        ...
        mLightGrayPaint.setColor(typedarray.getColor(0, 0xFF00FF));

        mTextPaint = new Paint();
        mTextPaint.setStyle(Paint.Style.FILL);
        mTextPaint.setAntiAlias(true);
        mTextPaint.setTextSize(60);
        mTextPaint.setColor(typedarray.getColor(0, 0xFF00FF));

        mCircumPaint = new Paint();
        mCircumPaint.setStyle(Paint.Style.FILL);
        mCircumPaint.setAntiAlias(true);
		mCircumPaint.setStrokeWidth(5);
        ...
        mOutSideCircumPaint.setColor(typedarray.getColor(0, 0xFF00FF));
        ...
        mOthersPaint.setTextSize(45);
		
        mOthersPaint.setColor(typedarray.getColor(0, 0xFF00FF));
        ...
        mCenterPaint.setColor(typedarray.getColor(0, 0xFF00FF));
        ...
        mSamllDegreePaint.setColor(typedarray.getColor(0, 0xFF00FF));
		...
		mDegrees = new Paint();
        mDegrees.setStyle(Paint.Style.STROKE);
        mDegrees.setAntiAlias(true);
        mDegrees.setTextSize(25);
        mDegrees.setColor(context.getResources().getColor(R.color.lightGray));
	...
	private void drawPosition() {
		...
		mCanvas.drawText(L, x + 100, y - 150, mDegrees);
		x = getRight();
		y = getBottom();
		if(longitude > 0)
		{
			L = "东经" + D2Dms(longitude);
		}else{
			L = "西经"+ D2Dms(longitude);
		}
		mCanvas.drawText(L, x - (getTextWidth(mDegrees, L) + 100), y - 150, mDegrees);
		L = "海拔 " + altitude + " 米";
		mCanvas.drawText(L, x / 2 - (getTextWidth(mDegrees, L) / 2), y - (120 - getTextHeight(mDegrees, L)), mDegrees);
		if(position != null){
		    mCanvas.drawText(position, x / 2 - (getTextWidth(mDegrees, position) / 2), y - (190 + getTextHeight(mDegrees, position)), mDegrees);
		}
	}
        ...
        for (int i = 0; i < 240; i++) {
            ...
            if (i==0||i==60||i==120||i==180){
                mCanvas.drawLine(getWidth() / 2, mTextHeight+mOutSideRadius-mCircumRadius+10,
                        getWidth() / 2,  mTextHeight+mOutSideRadius-mCircumRadius+30, mCircumPaint);
            }else{
                mCanvas.drawLine(getWidth() / 2, mTextHeight+mOutSideRadius-mCircumRadius+10,
